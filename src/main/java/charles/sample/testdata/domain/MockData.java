 ...
 * &#064;description  특정{@link  MockDataType}에 대응하는 가짜 데이터
 * 알고리즘으로 생성하지 않은 {@link  MockDataType}의 경우, 이 가짜 데이터를 랜덤으로 뽑아 출력한다.
 */
@Getter
@ToString
...
public class MockData {
  ...
  @Setter @Column(nullable = false, columnDefinition = "TEXT") private String mockDataValue;
